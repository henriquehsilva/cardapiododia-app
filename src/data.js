...
export const demoItems = [
  { id: '1', name: 'Frango grelhado', description: 'Arroz, feijão, salada e legumes da estação.', imageUrl: 'https://images.unsplash.com/photo-1532550907401-a500c9a57435?auto=format&fit=crop&w=800&q=80', likesCount: 18, order: 1 },
  { id: '2', name: 'Carne de panela', description: 'Cozida lentamente, com arroz, feijão e farofa.', imageUrl: 'https://images.unsplash.com/photo-1544025162-d76694265947?auto=format&fit=crop&w=800&q=80', likesCount: 27, order: 2 },
  { id: '3', name: 'Opção vegetariana', description: 'Abóbora assada, grão-de-bico e arroz integral.', imageUrl: 'https://images.unsplash.com/photo-1512621776951-a57141f2eefd?auto=format&fit=crop&w=800&q=80', likesCount: 11, order: 3 },
];
