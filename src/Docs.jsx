  ...
  return (
    <div className="docs-page">
      ...
      <main>
        ...
        <div className="docs-layout" id="recursos">
          ...
          <div className="docs-content">
            ...
            <section className="docs-section docs-dark" id="pedidos">
              <div><p className="eyebrow">04 · GESTÃO DE PEDIDOS</p><h2>Saiba o que vendeu e o que precisa de atenção.</h2><p>Todos os pedidos ficam reunidos no painel. Busque por cliente, prato, contato ou forma de pagamento e acompanhe o status de cada pedido.</p></div>
            ...
            <section className="docs-section docs-report" id="fechamento">
              <div>
                ...
                <h2>Transforme suas pedidos em um relatório pronto.</h2>
                ...
                <ul className="docs-checks">
                  <li><b>Resumo financeiro</b><span>Total vendido, quantidade de pedidos e itens, separados entre Pix e cartão.</span></li>
                  <li><b>Detalhamento completo</b><span>Data, cliente, contato, pratos, quantidades, preços e meio de pagamento.</span></li>
        ...
        <section className="docs-final"><p className="eyebrow">COMECE HOJE</p><h2>Sua próxima pedido pode começar aqui.</h2><p>Teste todos os recursos por 30 dias e publique sua loja sem precisar programar.</p><Link className="button light" to="/admin">Criar minha loja grátis →</Link></section>
      </main>
