...
function StoreDemo() {
  ...
  return (
    <div className="docs-demo store-demo">
      <div className="demo-browser"><i /><i /><i /><span>cardapiododia.app/loja/sua-loja</span></div>
      ...
      <div className="demo-product">
        ...
        <div><small>MARMITAS</small><h3>Frango grelhado</h3><p>Arroz, feijão, salada e legumes da estação.</p><strong>R$ 24,90</strong><div className="demo-actions"><button onClick={() => setLiked(!liked)}>{liked ? "♥ Curtido" : "♡ Curtir"}</button><button className="demo-add" onClick={() => setInCart(!inCart)}>{inCart ? "✓ Na sacola" : "Adicionar"}</button></div></div>
      </div>
    </div>
  );
}
    ...
    <div className="docs-page">
      ...
      <main>
        <section className="docs-hero" id="visao-geral">
          ...
          <h1>Tudo para transformar seus pratos em uma loja de verdade.</h1>
          ...
          <div className="docs-stats"><div><b>30 dias</b><span>de teste completo</span></div><div><b>10 fotos</b><span>por prato</span></div><div><b>3 formas</b><span>de fechar uma venda</span></div></div>
        </section>
        ...
        <div className="docs-layout" id="recursos">
          ...
          <div className="docs-content">
            ...
            <section className="docs-section docs-showcase" id="vitrine">
              <div><p className="eyebrow">02 · CARDÁPIO E PRATOS</p><h2>Um cardápio bonito, organizado e fácil de pedir.</h2><p className="docs-lead">Crie categorias, adicione até 10 fotos por prato e controle o que está disponível.</p><ul className="docs-checks"><li><b>Editor profissional</b><span>Formate a descrição com títulos, negrito, itálico, listas e links, acompanhando a prévia em tempo real.</span></li><li><b>Busca inteligente</b><span>Encontra por nome, categoria, descrição ou preço.</span></li><li><b>Galeria ampliável</b><span>Fotos em carrossel e zoom para mostrar cada detalhe.</span></li><li><b>Disponibilidade</b><span>Pause um prato sem precisar apagar o cadastro.</span></li><li><b>Interação</b><span>Curtidas e comentários ajudam a entender o interesse.</span></li></ul></div>
              <StoreDemo />
            </section>
            ...
            <section className="docs-section docs-dark" id="pedidos">
              <div><p className="eyebrow">04 · GESTÃO DE PEDIDOS</p><h2>Saiba o que vendeu e o que precisa de atenção.</h2><p>Todos os pedidos ficam reunidos no painel. Busque por cliente, prato, contato ou forma de pagamento e acompanhe o status de cada venda.</p></div>
              <div className="orders-demo"><div className="orders-top"><b>Pedidos recentes</b><span>⌕ Buscar pedidos</span></div><div className="order-row"><i>AS</i><div><b>Ana Souza</b><small>Frango grelhado · 2 itens</small></div><strong>R$ 49,80</strong><em className="paid">● Pago</em></div><div className="order-row"><i>RM</i><div><b>Rafael Melo</b><small>Carne de panela · 1 item</small></div><strong>R$ 26,90</strong><em>● Revisar Pix</em></div><div className="order-row"><i>CL</i><div><b>Carla Lima</b><small>Opção vegetariana · 1 item</small></div><strong>R$ 23,90</strong><em className="waiting">● Aguardando</em></div></div>
            </section>
            ...
            <section className="docs-section docs-report" id="fechamento">
              <div>
                ...
                <ul className="docs-checks">
                  ...
                  <li><b>Detalhamento completo</b><span>Data, comprador, contato, pratos, quantidades, preços e meio de pagamento.</span></li>
            ...
            <section className="docs-section" id="divulgacao">
              ...
              <div className="docs-share-grid"><article className="share-card"><div className="share-art">sua<br />marca<i>↗</i></div><h3>Compartilhamento visual</h3><p>Gere uma imagem do prato com marca, nome e preço para compartilhar pelo celular.</p></article><article><Icon>◍</Icon><h3>WhatsApp em um toque</h3><p>O link do prato abre uma conversa pronta, ideal para fechar vendas rapidamente.</p></article><article><Icon>♡</Icon><h3>Prova social</h3><p>Curtidas e comentários ficam visíveis na vitrine e aproximam clientes da sua marca.</p></article></div>
            </section>
          </div>
        </div>
      ...
      <footer className="docs-footer"><Link className="product-logo" to="/"><i>●</i> tô<span>vendendo</span></Link><span>© 2026 Cardápio do Dia · Feito para bons negócios.</span><Link to="/">Voltar ao início</Link></footer>
    </div>
  );
}
